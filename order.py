...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("order_URL")
...
class Order_Item(db.Model):
    ...
    def json(self):
        return {'order_item_id': self.order_item_id, 'Item_Id': self.Item_Id, 'quantity': self.quantity, 'order_id': self.order_id}
